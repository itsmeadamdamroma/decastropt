...
function injectToggle() {
  ...
  // Try new .mobile-menu first, then legacy #nav-mobile, then SPA .nav-mobile-menu
  const navMobile = document.querySelector('.mobile-menu') || document.querySelector('.hd-menu') || document.getElementById('nav-mobile') || document.querySelector('[data-testid="nav-mobile-menu"]');
